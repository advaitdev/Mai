...
/**
 * Movement scenario costs for humanoid pathfinding. Use with a World for block lookups.
 */
public enum Scenario {
    ...
    protected static int deltaX(PathPosition c, PathPosition p) { return (int) (c.getX() - p.getX()); }
    protected static int deltaY(PathPosition c, PathPosition p) { return (int) (c.getY() - p.getY()); }
    protected static int deltaZ(PathPosition c, PathPosition p) { return (int) (c.getZ() - p.getZ()); }
    ...
    protected static boolean hasBlocks() {
        return true;
    }
