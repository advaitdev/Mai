...
public final class HumanoidActionMessage {
    ...
    public static final String JUMP_SUCCESS = "Jumped successfully.";
    public static final String JUMP_FAILURE_NOT_ON_GROUND = "Jump failed; jumps cannot be performed unless the player entity is on the ground.";
    ...
    public static final String MINE_MESSAGE_FAILURE_TOOL_NOT_HELD = "The tool being used to mine is no longer being held.";
    ...
    public static final String BUILD_MESSAGE_FAILURE_OUT_OF_SIGHT = "The block is out of sight (try moving locations to target it).";
    ...
    // PVP //
    public static final String MOVE_RELATIVE_TO_TARGET_SUCCESS = "Moved to destination successfully.";
    public static final String MOVE_RELATIVE_TO_TARGET_FAILURE = "Did not move to destination successfully (did the entity die?).";

    // COMPOSITE //
    public static final String MULTI_ACTION_MESSAGE_SUCCESS = "MultiAction executed successfully.";
    public static final String MULTI_ACTION_MESSAGE_FAILURE = "MultiAction failed.";
