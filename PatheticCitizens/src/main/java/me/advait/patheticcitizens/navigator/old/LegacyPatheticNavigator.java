...
@Deprecated
public final class LegacyPatheticNavigator {
    ...
    public LegacyPatheticNavigator(PatheticNPC npc) {
        this.npc = npc;
    }

    public void setWalkableTarget(Location target) {
        LegacyPatheticNavigationStrategy navigationStrategy = new LegacyPatheticNavigationStrategy(
                npc,
                this,
                null,
                target,
