package me.advait.patheticcitizens.navigator.old;
...
@Deprecated
public class LegacyPatheticNavigationStrategy {

    private final PatheticNPC patheticNPC;
    private final LegacyPatheticNavigator patheticNavigator;
    ...
    public LegacyPatheticNavigationStrategy(PatheticNPC patheticNPC, LegacyPatheticNavigator patheticNavigator, Deque<Location> path, Location destination, float speed) {
